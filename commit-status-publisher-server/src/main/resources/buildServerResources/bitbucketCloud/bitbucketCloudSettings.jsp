    ...
    <script type="text/javascript">
      BS.BitbucketCloudTokenSupport = {
        ...
        tokenCallback: (it) => {
          ...
          BS.BitbucketCloudTokenSupport.updateTokenMessage();
        }
      };
      ...
      <td>
        ...
        <c:forEach items="${oauthConnections.keySet()}" var="connection">
          <div class="token-connection">
            ...
            <oauth:obtainToken connection="${connection}" className="btn btn_small token-connection-button" callback="BS.BitbucketCloudTokenSupport.tokenCallback">
              Acquire
            </oauth:obtainToken>
          </div>
        </c:forEach>
