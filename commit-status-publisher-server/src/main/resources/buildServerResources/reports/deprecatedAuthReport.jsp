...
<div>
  Commit Status Publisher in <admin:editBuildTypeLinkFull buildType="${buildType}" cameFromUrl="${cameFromUrl}"/> Build Configuration
  uses username/password authentication that is deprecated in  <c:out value="${publisherType}" />.
  You may consider changing it to <strong>Access Token</strong> instead.
</div>