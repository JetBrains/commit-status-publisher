...
public class StashSettings extends AuthTypeAwareSettings implements CommitStatusPublisherSettings {
  ...
  @NotNull
  public String getId() {
    return StashConstants.PUBLISHER_ID;
  }
  ...
  public String describeParameters(@NotNull Map<String, String> params) {
    ...
    final String url = params.get(StashConstants.BASE_URL);
    if (url != null) {
      ...
      public Collection<InvalidProperty> process(Map<String, String> params) {
        ...
        switch(authType) {
          case Constants.PASSWORD:
            ...
            mandatoryString(StashConstants.USERNAME, "Username must be specified", params, errors);
            mandatoryString(StashConstants.PASSWORD, "Password must be specified", params, errors);
            break;

          case Constants.AUTH_TYPE_STORED_TOKEN:
            params.remove(StashConstants.USERNAME);
            params.remove(StashConstants.PASSWORD);
  ...
  public void testConnection(@NotNull BuildTypeIdentity buildTypeOrTemplate, @NotNull VcsRoot root, @NotNull Map<String, String> params) throws PublisherException {
    ...
    String apiUrl = params.getOrDefault(StashConstants.BASE_URL, guessApiURL(root.getProperty("url")));
  ...
  public List<OAuthConnectionDescriptor> getOAuthConnections(@NotNull SProject project, @NotNull SUser user) {
    return myOAuthConnectionsManager.getAvailableConnectionsOfType(project, StashConstants.OAUTH_PROVIDER_TYPE).stream()
  ...
  protected String getUsername(@NotNull Map<String, String> params) {
    return params.get(StashConstants.USERNAME);
  }

  @Nullable
  @Override
  protected String getPassword(@NotNull Map<String, String> params) {
    return params.get(StashConstants.PASSWORD);
  }
